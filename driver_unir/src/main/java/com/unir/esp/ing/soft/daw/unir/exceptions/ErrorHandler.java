...
public class ErrorHandler {
    ...
    @ExceptionHandler(value = DriverAlredyExist.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public @ResponseBody ExceptionsDto handleUserAlreadyExistsException( DriverAlredyExist ex ) {
        return new ExceptionsDto(HttpStatus.CONFLICT.value(), ex.getMessage());
    }

    @ExceptionHandler(value = DriverNotFound.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public @ResponseBody ExceptionsDto handleUserNotFoundException( DriverNotFound ex ) {
        return new ExceptionsDto(HttpStatus.CONFLICT.value(), ex.getMessage());
    }
